  ...
  return (
    ...
    <div className="w-full max-w-screen-md text-balance">
      <div className="flex flex-col text-center justify-center relative">
        <img className="object-cover w-auto h-1/2 bg-center dark:opacity-5  "
        src="imageBlog/line-pattern.png"></img>
        <div className="flex absolute flex-col space-y-4 w-full">
          <h1 className='font-bold text-5xl text-black dark:text-white'>Create</h1>
          <p className="text-xl text-black dark:text-zinc-600 text-pretty">Create new blog post</p>
        </div>
      </div>
