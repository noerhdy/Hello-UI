...
const NavDoc = () => {
  ...
  const getSpanClassName = (index) => {
    return index === hoveredIndex
      ? "visible text-white p-1 text-sm absolute -top-10 left-1/2 transform -translate-x-1/2 px-2 rounded-md bg-blue-500 transition-opacity duration-300 opacity-100"
